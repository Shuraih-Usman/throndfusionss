...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="/admin/dashboard" class="text-muted fw-light">Dashboard /</a> <a href="/admin/campaigns" class="text-muted fw-light">Campaigns /</a> Investments</h4>
    ...
    <div id="model" data-name="investings"></div>
