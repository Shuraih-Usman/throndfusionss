...
use App\Models\AdminModel\Service_cat;

class Service_cats extends Controller
{
    //
    ...
    public function add($request)
    {
        ...
        if ($validator->fails()) {
            ...
            $user = new Service_cat();
            $user->title = $request->title;
            $user->description = $request->description;
            $user->save();
            $s = 1;
            $m = "You have successfully added a Service category";
        }
    ...
    public function list($request) 
    {
        ...
        $totalRecords = Service_cat::count();
        ...
        $s = 0;
            ...
            if( $validator->fails() ) {
                ...
                try {
                    ...
                    $campaign = Service_cat::find($request->id);
